...
const themeColors = {
  light: {
    ts: [0.4, 0.6, 0.9], // TypeScript blue
    tailwind: [0.38, 0.84, 0.96] // Tailwind teal
  },
  dark: {
    ts: [0.2, 0.4, 0.8], // Darker TypeScript blue
    tailwind: [0.2, 0.6, 0.8] // Darker Tailwind teal
  }
};
...
export default function Dither({
  ...
  // Use the theme-specific color if available, otherwise use the provided waveColor
  const finalWaveColor = themeColor || waveColor;
